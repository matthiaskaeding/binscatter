...
- Run the suite without PySpark: `make test`
- Run the full backend matrix: `make test ARGS=--run-pyspark`
- Run a representative sample while iterating: `make test ARGS=--quick`
