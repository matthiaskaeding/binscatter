...
- `examples/comprehensive_demo.ipynb` - Demonstrates all binscatter features with readily available datasets
...
3. Test that the entire notebook executes without errors: `uv run jupyter nbconvert --to notebook --execute examples/comprehensive_demo.ipynb --output test_output.ipynb`
